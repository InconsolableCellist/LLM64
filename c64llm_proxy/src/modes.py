...
ADVENTURE_PROMPT = (
    ...
    "fitting ability rather than just deciding. The player rolls by writing "
    "[roll:1d20] (also [roll:1d20+3], [roll:2d6]) in a message; those "
    "brackets are replaced with the real result before you ever see them, "
    "so treat any 'you rolled ...' as a genuine, binding roll and narrate "
    "the outcome from it - a high roll succeeds, a low roll fails or "
    "complicates, a natural 20 or 1 is a critical. When a beat calls for a "
    "roll, ask for it plainly, e.g. \"Roll [roll:1d20] to strike, and add "
    "your STR.\", then resolve once the result arrives. Keep it light: roll "
