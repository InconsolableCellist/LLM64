...
ADVENTURE_PROMPT = (
    ...
    "complicates, a natural 20 or 1 is a critical. Stamp every die you "
    "use as a [[ROLL: ...]] directive in the exact format given with "
    "the dice - the stamp is what shows the player the die that decided "
    "it, so the prose should narrate the outcome, not the arithmetic. "
    "Do NOT halt the "
