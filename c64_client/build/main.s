...
L026E:	lda     _pending_ack
	...
	ldx     #>(L0190)
	jmp     L026C
L026F:	lda     _pending_ack
	cmp     #$02
	bne     L0270
	lda     #<(L0196)
	ldx     #>(L0196)
L026C:	jsr     _ui_status
L0270:	lda     #$00
	sta     _pending_ack
	jmp     incsp1
...
L0273:	lda     _conv_sel
	...
	jsr     _conv_draw
	jmp     incsp1
L01F2:	lda     _conv_count
	beq     L01FD
	jsr     _conv_load_selected
	jmp     incsp1
L01F7:	jsr     _conv_close
	jmp     incsp1
L01E0:	ldy     #$00
	lda     (sp),y
	cmp     #$0D
	...
	beq     L0212
	jmp     L0275
L01FF:	jsr     _send_message
	jmp     incsp1
L0204:	jsr     _new_conversation
	jmp     incsp1
L0207:	jsr     _cancel_stream
	jmp     incsp1
L0274:	lda     _state
	bne     L01FD
	jsr     _conv_open
	jmp     incsp1
L020F:	jsr     _help_open
	jmp     incsp1
L0212:	lda     #$01
	jsr     _chat_scroll
	jmp     incsp1
...
L0234:	jsr     _kbhit
	...
	jsr     _cgetc
	jmp     L0234
L0232:	jsr     _proto_send_new_conversation
	ldx     #$0F
	lda     #$A0
	jsr     _wait_for_ack
	lda     #$02
